...
class Post2sControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create post2" do
    assert_difference('Post2.count') do
      post post2s_url, params: { post2: { body: @post2.body, published: @post2.published, title: @post2.title } }
    end
  ...
  test "should update post2" do
    patch post2_url(@post2), params: { post2: { body: @post2.body, published: @post2.published, title: @post2.title } }
